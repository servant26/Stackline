        ...
        >
            ...
            >
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <h2 className="text-base font-semibold text-gray-900 dark:text-white">Complete Note to Done</h2>
                </div>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-5 ml-4">{update.title}</p>
