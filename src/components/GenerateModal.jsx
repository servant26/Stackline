    ...
    return (
        <div className="relative" ref={selectRef}>
            ...
            <button
                ...
                className={`w-full flex items-center justify-between rounded-xl border bg-white px-4 py-2.5 text-sm text-gray-800 transition-all focus:outline-none ${
                    open
            ...
            <div
                className={`absolute left-0 right-0 z-50 mt-1.5 rounded-xl border border-gray-100 bg-white p-1.5 shadow-xl ring-1 ring-black/5 origin-top transition-all duration-200 ease-out ${
                    open
                    ...
                    return (
                        <button
                            ...
                            className={`w-full flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-colors ${
                                isDisabled
                                    ? 'opacity-40 cursor-not-allowed bg-gray-50/60 text-gray-400'
                                    : isSelected
                                ...
                                {opt.dot && (
                                    <span
                                        className={`w-2 h-2 rounded-full ${
                                            isDisabled ? 'bg-gray-300' : opt.dot
                                        }`}
                                    />
                                )}
...
function GenerateModal({ tasks = [], updates = [], onClose }) {
    ...
    return (
        ...
        >
            <div
                className="relative bg-white rounded-2xl border border-gray-100 shadow-2xl p-7 w-full max-w-xl max-h-[90vh] overflow-visible"
            ...
            >
                ...
                <div className="flex items-center justify-between mb-6 pb-3 border-b border-gray-100">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-base font-semibold text-gray-900">Generate Summary</h2>
                    </div>
                    <button
                        type="button"
                        onClick={onClose}
                        title="Close"
                        className="text-gray-400 hover:text-gray-600 p-1.5 rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="w-5 h-5"
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full mt-2 px-4 py-2.5 text-sm rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-700 active:bg-blue-800 disabled:opacity-50 transition-colors shadow-sm flex items-center justify-center gap-2"
                    >
                        {loading ? (
                            <>
                                <svg
                ...
                {error && (
                    <div className="mt-4 p-3.5 rounded-xl bg-red-50 border border-red-100 text-red-600 text-sm">
                        {error}
                    </div>
                )}
                ...
                {summary && (
                    <div className="mt-6 pt-5 border-t border-gray-100">
                        ...
                        <div className="bg-gray-50 border border-gray-200/80 rounded-xl p-4 max-h-[280px] overflow-y-auto">
