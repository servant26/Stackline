                    ...
                    <div className="space-y-5">
                        ...
                        <div className="pt-2 border-t border-gray-100">
                            ...
                            {loading ? (
                                ...
                                <div className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3.5 py-3 text-sm text-gray-400 italic">
                                ...
                                <div className="space-y-2.5">
                                    {paginatedHistory.map((h, idx) => (
                                        ...
                                        >
                                            ...
                                            <p className="text-sm text-gray-700 leading-relaxed text-justify">{h.description}</p>
                                            {h.image_url && (
                                                <img
                                                    src={h.image_url}
                                    ...
                                    {totalPages > 1 && (
                                        <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                                            <button
                                                ...
                                                disabled={page === 1}
                                                className="text-xs px-3 py-1.5 rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed font-medium"
                                            >
                                                ← Prev
                                            </button>
                    ...
                    <form onSubmit={handleSaveEdit} className="w-full space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border border-gray-200 rounded-lg px-3.5 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300"
                                required
                                autoFocus
                            />
                        </div>
